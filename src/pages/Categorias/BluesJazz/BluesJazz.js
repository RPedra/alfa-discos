...
function BluesJazz() {
    ...
    useEffect(() => {
        const filterCds = cds.filter((response) => response.categoria === "BluesJazz");
        setFilter(filterCds);
    }, [])
    ...
    <>
        <div className="pagina-BluesJazz">
            ...
            <div className="titulo">
                ...
                <Card.Title rounded style= {{color: 'white' }} >Blues e Jazz</Card.Title>
                </Card>
                <div className="BluesJazz" >
                        {filter?.map((cd) => (
